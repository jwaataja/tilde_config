...
Gem::Specification.new do |spec|
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata["source_code_uri"] = "https://github.com/jwaataja/tilde.config"
    spec.metadata["changelog_uri"] = "https://github.com/jwaataja/tilde.config/blob/master/CHANGELOG.md"
  else
